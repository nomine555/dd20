...
//var debug_content_file = "..\\twine\\dd20-3.5-es.html";
...
function DrawLines() { 
    new LeaderLine(document.getElementById('comienza-aventura'),document.getElementById('ataque-escuela'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('ataque-escuela'),document.getElementById('torre-vigilancia'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('torre-vigilancia'),document.getElementById('buscando-culpables'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('ataque-escuela'),document.getElementById('buscando-culpables'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('buscando-culpables'),document.getElementById('glaucom'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('glaucom'),document.getElementById('saliendo-exterior'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('buscando-culpables'),document.getElementById('saliendo-exterior'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('saliendo-exterior'),document.getElementById('plaza-pueblo'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('plaza-pueblo'),document.getElementById('ballena-blanca'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('ballena-blanca'),document.getElementById('prisionero'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('prisionero'),document.getElementById('nizgul'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('buscando-culpables'),document.getElementById('nizgul'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('nizgul'),document.getElementById('tesoro'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('buscando-culpables'),document.getElementById('tesoro'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('tesoro'),document.getElementById('buscando-huesos'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('buscando-huesos'),document.getElementById('cementerio'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('cementerio'),document.getElementById('conclusion'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('buscando-culpables'),document.getElementById('patio-armas'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('buscando-culpables'),document.getElementById('biblioteca'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('biblioteca'),document.getElementById('encerrados'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('patio-armas'),document.getElementById('biblioteca'), {color: 'black', size: 3, path: 'straight'});
    new LeaderLine(document.getElementById('patio-armas'),document.getElementById('encerrados'), {color: 'black', size: 3, path: 'straight'});
}
...
var aventuralinks_5a_es = [    
    /* Monsters */
    ["Doris", "./lugares.html?param=@monsters&room=-1"],
    ["Doris, cambiaformas", "./lugares.html?param=@monsters&room=-1"],
    ["Lord Gimion", "./lugares.html?param=@monsters&room=-2"],
    ["Lord Gimion, Fantasma Protector", "./lugares.html?param=@monsters&room=-2"],
    ["Maleantes", "./lugares.html?param=@monsters&room=-3"],
    ["Bestia fundidora", "./lugares.html?param=@monsters&room=-4"],
    ["Bestias fundidoras", "./lugares.html?param=@monsters&room=-4"],
    
    /* Hojas de personaje */
    ["Hoja de personaje de Wilbur", "./lugares.html?param=@fichas&room=-1"],
    ["Hoja de personaje de Yonsee", "./lugares.html?param=@fichas&room=-2"],
    ["Hoja de personaje de Monak", "./lugares.html?param=@fichas&room=-3"],
    ["Hoja de personaje de Raghar", "./lugares.html?param=@fichas&room=-4"],
    ["Hoja de personaje del Sr. Pirs", "./lugares.html?param=@fichas&room=-5"],
    ["Hoja de personaje de Erendur", "./lugares.html?param=@fichas&room=-6"],
...
var aventuralinks_5a_en = [  
    /* Monsters */
    ["Doris", "./lugares.html?param=@monsters&room=-1"],
    ["Doris, shapeshifter", "./lugares.html?param=@monsters&room=-1"],
    ["Lord Gimion", "./lugares.html?param=@monsters&room=-2"],
    ["Lord Gimion, Wraith", "./lugares.html?param=@monsters&room=-2"],
    ["Ruffians", "./lugares.html?param=@monsters&room=-3"],
    ["Smelter Beast", "./lugares.html?param=@monsters&room=-4"],
    ["Smelter Beasts", "./lugares.html?param=@monsters&room=-4"],
    
    /* Fichas */
    ["Wilbur character sheet", "./lugares.html?param=@fichas&room=-1"],
    ["Yonsee character sheet", "./lugares.html?param=@fichas&room=-2"],
    ["Monak character sheet", "./lugares.html?param=@fichas&room=-3"],
    ["Raghar character sheet", "./lugares.html?param=@fichas&room=-4"],
    ["Mr. Pirs character sheet", "./lugares.html?param=@fichas&room=-5"],
    ["Erendur character sheet", "./lugares.html?param=@fichas&room=-6"],
