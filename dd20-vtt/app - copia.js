...
const options = {
  key: fs.readFileSync('C:\\Certbot\\live\\tablero.digitald20.com\\fullchain.pem'),
  cert: fs.readFileSync('C:\\Certbot\\live\\tablero.digitald20.com\\privkey.pem')
};
...
//  .on("listening", () =>
//    console.log("Feathers server listening on localhost:8443")
//  );
