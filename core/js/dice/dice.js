...
(function(dice) {
    ...
    this.dice_color = '#44006f';
    this.ambient_light_color = {color:0xefdfd5};
    this.spot_light_color = 0xefdfd5;
    this.selector_back_colors = { color: 0x404040, shininess: 0, emissive: 0x858787 , transparent:true, opacity:0.6};
    this.desk_color = { color: 0xffffff, transparent:true, opacity:0.2 };
    ...
    this.dice_box.prototype.reinit = function(container, dimentions) {
        ...
        this.desk = new THREE.Mesh(new THREE.PlaneGeometry(this.w * 2, this.h * 2, 1, 1), 
                new THREE.MeshPhongMaterial(that.desk_color));
    ...
    this.dice_box.prototype.search_dice_by_mouse = function(ev) {
        ...
        var corr = -0.1*this.cw;        
        var intersects = (new THREE.Raycaster(this.camera.position, 
                    (new THREE.Vector3((m.x + corr - this.cw) / this.aspect,
    ...
    this.dice_box.prototype.bind_mouse = function(container, notation_getter, before_roll, after_roll) {
        ...
        //    catch(e) {console.log("Traducción y dados a la vez!")}
